...
export const translations: Record<Language, TranslationDictionary> = {
  ka: {
    ...
    interactiveMapSub: 'გაიგე სად მდებარეობს თითოეული აქტივობა. დააჭირე ნიშნულებს დეტალების სანახავად.',
    mapPrompt: 'აირჩიე აქტივობა რუკაზე',
  ...
  en: {
    ...
    interactiveMapSub: 'Locate each activity on our path. Click the nodes to reveal details.',
    mapPrompt: 'Select an activity on the map',
  ...
  ru: {
    ...
    interactiveMapSub: 'Узнайте расположение всех развлечений. Нажмите на метки для деталей.',
    mapPrompt: 'Выберите активность на карте',
  ...
  he: {
    ...
    interactiveMapSub: "אתרו כל פעילות במסלול שלנו. לחצו על הנקודות לחשיפת פרטים.",
    mapPrompt: "בחר פעילות במפה",
  ...
  ar: {
    ...
    interactiveMapSub: "حدد موقع كل نشاط على مسارنا. انقر على النقاط لكشف التفاصيل.",
    mapPrompt: "اختر النشاط على الخريطة",
